...
function PANEL:Init()
	...
	local headpos = self.Entity:GetBonePosition(self.Entity:LookupBone("ValveBiped.Bip01_Head1"))
...
function PANEL:Paint()
	...
	local pose = self.Entity:LookupSequence("pose_standing_01")
	self.Entity:SetSequence(pose)
...
function PANEL:DrawOtherModels()
	...
	if PS.HoverModel then
		...
		if ITEM.NoPreview then return end 
		if ITEM.WeaponClass then return end 
