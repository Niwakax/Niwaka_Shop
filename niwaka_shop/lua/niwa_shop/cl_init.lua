...
include("vgui/DPointShopCategory.lua")

include("cl_greetings.lua")

include("categories/cl_standard_compat.lua")
include("categories/cl_standard_derma.lua")
...
function PS:ShowColorChooser(item, modifications)
	local chooser = vgui.Create("DPointShopChooser")
